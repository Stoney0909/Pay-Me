...
public class NotificationListAdapter extends ArrayAdapter<Transaction> {
    ...
    public NotificationListAdapter(ArrayList<Transaction> data, Context context) {
        super(context, R.layout.notification_history, data);
        this.dataSet = data;
